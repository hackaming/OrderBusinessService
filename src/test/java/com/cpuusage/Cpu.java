...
public class Cpu { 
    private static final int CPUTIME = 30; 
      ...
      private static String linuxVersion = null; 
            public double getCpuRatio() throws IOException{ 
            // 操作系统 
      ...
      public MonitorInfoBean getMonitorInfoBean() throws Exception { 
          ...
          String osName = System.getProperty("os.name"); 
          // 总的物理内存 
          long totalMemorySize = 55l; 
          // 剩余的物理内存 
          long freePhysicalMemorySize = 55l; 
          // 已使用的物理内存 
          long usedMemory = 55l; 
          // 获得线程总数 
      ...
      private long[] readCpu1(final Process proc) throws IOException{
